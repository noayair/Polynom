...
=======
        ...
        Polynom p3 = new Polynom("-x+5x^2-3.8x^3");
        Polynom p4 = new Polynom("9");
        assertEquals(17 , p1.f(17) , 0.00001);
        assertEquals(-24.5 , p2.f(4) , 0.00001);
        assertEquals(-12.39999 , p3.f(2) , 0.00001);
        assertEquals(9 , p4.f(30) , 0.00001);
    }

    @Test
    public void add() { //add monom to polynom
        Polynom p1 = new Polynom("x");
        Polynom p2 = new Polynom("3.5-7x");
        Polynom p3 = new Polynom("-x+5x^2-3.8x^3");
...
=======
    public void testAdd() { //add polynom to polynom
        Polynom p1 = new Polynom("x");
        Polynom p2 = new Polynom("3.5-7x");
        Polynom p3 = new Polynom("-x+5x^2-3.8x^3");
        Polynom p4 = new Polynom("9");
...
=======
    ...
    @Test
    public void multiply() { //polynom*monom
        Polynom p1 = new Polynom("x");
        Polynom p2 = new Polynom("3.5-7x");
        Polynom p3 = new Polynom("-x+5x^2-3.8x^3");
>>>>>>> 394d8e4d2355dcaa76ccfb8c1b8bb6374cd81a33
...
=======
    ...
    @Test
    public void testMultiply() { //polynom*polynom
        Polynom p1 = new Polynom("x");
        Polynom p2 = new Polynom("3.5-7x");
        Polynom p3 = new Polynom("-x+5x^2-3.8x^3");
        Polynom p4 = new Polynom("9");
...
=======
        Polynom p1 = new Polynom("2x+x^2");
        assertEquals(-2 , p1.root(-3, -1, 0.000001) , 0.00001);
>>>>>>> 394d8e4d2355dcaa76ccfb8c1b8bb6374cd81a33
    }
